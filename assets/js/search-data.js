...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "Publications are also listed on Google Scholar.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
      ...
      },{id: "books-introduction-to-catastrophe-risk-modelling",
          ...
          description: "",
          section: "News",},{id: "news-update-of-the-website",
          title: 'Update of the website!',
          description: "",
          section: "News",},{id: "projects-2017-puebla-earthquake",
          title: '2017 Puebla earthquake',
          description: "Reconnaissance mission in Mexico City following the 19 Sep 2017 earthquake",
          section: "Projects",handler: () => {
              window.location.href = "/projects/2017_Puebla_earthquake/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%72%6F%65%73%6C%69%6E@%68%6F%74%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/samroeslin", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/samroeslin", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=OVBqXFEAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
